...
<body>
    ...
    <div class = "register">
        <form class = "register-form-content">
            ...
            <div>
                <br>
                <button onclick="window.location.href='./login.php'" type = "button" class = "cancel-button">Cancel</button>
                <button type="button" onclick="Inregistrare()" class = "signup-button">Register</button>
            </div>
        </form>
    </div>
</body>
